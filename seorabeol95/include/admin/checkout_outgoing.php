        ...
        <nav class="navbar fixed-top navbar-toggleable-md navbar-dark scrolling-navbar double-nav">
            ...
            <div class="float-xs-left">
                ...
                <ol class="header-breadcrumb breadcrumb fp-header-breadcrumb hidden-md-down">
                        <li class="breadcrumb-item"><a href="ongoing.php" style="font-size: 15px;font-weight: 300"><i class="fa fa-calendar-times-o"></i> Outgoing</a></li>
                        <li class="breadcrumb-item active"><a href="php/check_outgoing.php?id=<?php echo $id ?>" style="font-size: 15px;font-weight: 300"><i class="fa fa-user-o"></i> Guest</a></li>
