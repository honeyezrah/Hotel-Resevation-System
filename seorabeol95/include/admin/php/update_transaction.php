...
<div class="mr-auto">
                <ol class="header-breadcrumb breadcrumb fp-header-breadcrumb hidden-md-down">
                        <li class="breadcrumb-item"><a href="../transaction.php" style="font-size: 15px;font-weight: 300"><i class="fa fa-calendar-times-o"></i> Transaction</a></li>
                        <li class="breadcrumb-item active"><a href="check_transaction.php?id=<?php echo  $id ?>" style="font-size: 15px;font-weight: 300"><i class="fa fa-user-o"></i> Guest</a></li>
                         <li class="breadcrumb-item active" style="font-size: 15px;font-weight: 300"><i class="fa fa-calendar-plus-o"></i> Extend</a></li>
                 </ol>
            </div>
...
<!-- Notification -->
  <div class="modal fade right" id="notification" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-full-height modal-right modal-md" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header" style="background-color: #222">
                ...
                <h4 class="modal-title w-100 text-white" id="myModalLabel"><i class="fa fa-bell"></i>  Notification</h4>
            </div>
            <!--Body-->
...
<!--Ongoing page-->
    ...
    <div class="container" style="margin-top:3%;">
      <div class="row" >
        ...
        <div class="col-lg-7">
          <div class="example z-depth-1" style="height:120%;background-color: white;">
            <h2 class="z-depth-1" style="background-color:#2ad1a3;position:relative;top:-30px;margin-left:35px;margin-right:35px;text-align:center;padding:20px;border-radius:5px;color:white">Reservation Information <i class="fa fa-hotel prefix"></i></h2>
    ...
    ?>
    <div class="col-lg-5">
                  <div class="card-wrapper" style="width: 120%;height: 120%;margin-top:0px">
                        <div id="card-1" class="card-rotating effect__click">
                            <div class="face front" style="padding: 20px">
                                <div class="card-block">
                                    <h4 class="z-depth-1" style="background-color:#2ad1a3;position:relative;top:-70px;margin-left:35px;margin-right:35px;padding:20px;border-radius:5px;color:white">Extend Check-in <i class="fa fa-calendar prefix"></i></h4>
                                              <?php
                                                $id = $_GET['id'];
                                                $sql = "SELECT * FROM booking WHERE customer_no='$id'";
                                                $results = mysqli_query($db,$sql);
                                                ...
                                                {
                                                ?>
                                    <form action="verify_transaction.php?id=<?php echo $rows[0]; ?>" method="post" id="extend" onmouseout="counted(this);">
