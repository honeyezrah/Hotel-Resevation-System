        ...
        <div class="col-lg-7">
          <div class="example z-depth-1" style="height:102%;background-color: white ">
            ...
            <div style="padding-left:20px;padding-right:25px;">
              ...
              <div  align="right">
              <a href="update_outgoing.php?id=<?php echo $rows[0]; ?>"><button class="btn" type="button" style="background-color:#2ad1a3"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Update</button></a>
              <a href="../checkout_outgoing.php?id=<?php echo $rows[0];?>"><button class="btn" type="button" style="background-color:#2ad1a3"><i class="fa fa-calendar-times-o" aria-hidden="true"></i> Checkout</button></a>
            </div>
          </div>
        </div>
        </form>
