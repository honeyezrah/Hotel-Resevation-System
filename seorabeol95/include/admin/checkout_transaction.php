        ...
        <nav class="navbar fixed-top navbar-toggleable-md navbar-dark scrolling-navbar double-nav">
            ...
            <div class="float-xs-left">
                ...
                <ol class="header-breadcrumb breadcrumb fp-header-breadcrumb hidden-md-down">
                        ...
                        <li class="breadcrumb-item active"><a href="php/check_transaction.php?id=<?php echo $id ?>" style="font-size: 15px;font-weight: 300"><i class="fa fa-user-o"></i> Guest</a></li>
        ...
        <div class="row">
             <div class="col-lg-8" style="margin-left: -5%;margin-right:3%">
              <div class="table-responsive margin-small-top" style="width:107%;height: auto">
                <div class="card-table z-depth-1">
                  <div class="card-table-content" style="padding:30px">
                    <h3 class="table-float" style="background-color:#2ad1a3;color:white"><i class="fa fa-user-circle-o" aria-hidden="true"></i> Guest Info </h3>
                          <div class="row">
                                <?php
                                    $id = $_GET['id'];
            ...
            <div class="col-lg-4" style="">
              <div class="table-responsive margin-small-top" style="width:120%;height: auto">
                <div class="card-table">
                  <div class="card-table-content" style="padding:30px">
                    <h3 class="table-float" style="background-color:#2ad1a3;color:white"><i class="fa fa-chain-broken" aria-hidden="true"></i>  Damaged Item </h3>
            ...
            <div class="col-lg-6" style="margin-top: 3.2%;margin-left: -5%;margin-bottom: 5%">
              <div class="table-responsive margin-small-top " style="width:105%">
                <div class="card-table z-depth-1">
                  <div class="card-table-content" style="padding:30px">
                    <h3 class="table-float" style="background-color:#2ad1a3;color:white"><i class="fa fa-money" aria-hidden="true"></i> Payment </h3>
                <div class="row">
                                <div class="col-lg-6">
                                      <div class="md-form">
                ...
                <div class="col-lg-6" style="margin-top: 5%;margin-left: 5%;margin-bottom:5%;font-family: Merchant Copy">
                    ...
                    <h3 class="table-float" style="background-color:#2ad1a3;color:white;font-family: roboto" align="center"><i class="fa fa-file-text-o" aria-hidden="true"></i> Reciept</h3>
