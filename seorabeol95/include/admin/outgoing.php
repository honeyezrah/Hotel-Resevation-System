...
<main>
    <div class="container">
        <div class="table-responsive margin-small-top">
          ...
          <button type="button" class="btn btn-tw" style="width: 13%;height: 80px;padding-left: 3%;background-color: #2ad1a3"><i class="fa fa-calendar-times-o" aria-hidden="true" style="font-size: 40px"></i></button>
          </div>
          <div class="float-xs-left" style="margin-left:3%;margin-top:-3%;text-align: left">
            <h3>Outgoing</h3>
            <p style="color:grey">End  of the Booking</p>
          </div>
                ...
                <thead>
                  ...
                  <tbody align="center" >
                        <?php
                         date_default_timezone_set('Asia/Manila');
                         $date = date('m/d/Y');
                         $sql = "SELECT * FROM booking WHERE status ='approved'AND departure_date <= '".$date."' ORDER BY customer_no DESC";
                        $results = mysqli_query($db,$sql);
                        ...
                        <tr>
                          ...
                          <td><a href="php/check_outgoing.php?id=<?php echo $rows[0]; ?>"><i class="fa fa-pencil-square-o" aria-hidden="true" style="color:#2ad1a3;"></i></a></td>
                        </tr>
                        <?php
                        }
                        }
