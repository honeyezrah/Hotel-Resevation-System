            ...
            <p style="color:grey">Proccessing of the Booking</p>
              ...
              <table class="table table-hover table-pending table-striped" style="margin-top:3%">
                <thead>
                  ...
                  if(isset($id))
                          {
                         $sql1 = "SELECT * FROM booking WHERE  customer_no = '$id' AND status ='approved'  ORDER BY customer_no DESC LIMIT 1" ;
                        $results1 = mysqli_query($db,$sql1);
                        while($rows1 = mysqli_fetch_array ($results1)){
                          ?>
                        <tr class="fadeInLeft animated">
                          ...
                          <td><a href="php/check_transaction.php?id=<?php echo $rows1[0]; ?>"><i class="fa fa-pencil-square-o" aria-hidden="true" style="color:#2ad1a3;"></i></a></td>
                        </tr>
                          <?php
                          }
                        }
                        ...
                        <tr>
                          ...
                          <td style="font-weight: 300">Paid </td>
                          <td><a href="php/check_transaction.php?id=<?php echo $rows[0]; ?>"><i class="fa fa-pencil-square-o" aria-hidden="true" style="color:#2ad1a3;"></i></a></td>
                        </tr>
                        <?php
                        }
                        }
                        ...
                        {
                        echo "<td colspan='6'>No Transaction</td>";
                        }
                        ?>
                  </tbody>
                </table>
